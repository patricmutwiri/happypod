...
//  intro: "Count the number of the points on the dominoes then type the result on your keyboard."
  //: Help goal
  goal: qsTr("
    * Counting of concrete objects (dots dominoes)
    * Identification of the numbers keys on the keyboard
    * Motor-coordination
  ...
  //: Help manual
  manual: qsTr("Count the number of dots on the dominoes before they reach the ground. With the keyboard, type the number of dots you see on the falling dominoes.")
  credit: ""
